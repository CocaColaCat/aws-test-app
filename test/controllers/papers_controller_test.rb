...
class PapersControllerTest < ActionController::TestCase
  ...
  test "should create paper" do
    assert_difference('Paper.count') do
      post :create, paper: { article: @paper.article, author: @paper.author, rating: @paper.rating, title: @paper.title }
    end
  ...
  test "should update paper" do
    patch :update, id: @paper, paper: { article: @paper.article, author: @paper.author, rating: @paper.rating, title: @paper.title }
    assert_redirected_to paper_path(assigns(:paper))
  end
